...
class AppColors {
  ...
  static const Color mapBg         = Color(0xFF0D1B2E);
  static const Color mapBlock      = Color(0xFF111E30);
  static const Color mapMajorRoad  = Color(0xFF1A2E46);
  static const Color mapMinorRoad  = Color(0xFF152333);
  static const Color mapRoute      = Color(0xFF3B82F6);
  static const Color mapPark       = Color(0xFF0B2416);
